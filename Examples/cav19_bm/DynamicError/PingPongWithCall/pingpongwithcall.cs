...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_pingpongwithcall()
            {
                event_Success = new PrtEventValue(new PrtEvent("Success", Types.type_4_1894851212, 1, false));
                event_Pong = new PrtEventValue(new PrtEvent("Pong", Types.type_4_1894851212, 1, false));
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_1894851212;
            public static PrtType type_2_1894851212;
            public static PrtType type_3_1894851212;
            public static PrtType type_4_1894851212;
            public static PrtType type_PONG;
            static public void Types_pingpongwithcall()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_1894851212 = new PrtIntType();
                Types.type_2_1894851212 = new PrtBoolType();
                Types.type_3_1894851212 = new PrtEventType();
                Types.type_4_1894851212 = new PrtNullType();
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\dynamicerror\\\\pingpongwithcall\\\\pingpongwithcall.p(43,7,43,12): error PC1001: Raised event must be non-null");
        ...
        public class Main : PrtImplMachine
        {
            ...
            public class AnonFun4_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun4_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\dynamicerror\\\\pingpongwithcall\\\\pingpongwithcall.p(23,6,23,11): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            public class AnonFun7_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun7_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\dynamicerror\\\\pingpongwithcall\\\\pingpongwithcall.p(15,6,15,11): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            static Main()
            {
                ...
                Main_Ping_Init = new Main_Ping_Init_Class("Main_Ping_Init", AnonFun7, AnonFun8, false, StateTemperature.Warm);
                PrtTransition transition_1 = new PrtTransition(PrtFun.IgnoreFun, Main_Ping_SendPing, true);
                Main_Ping_WaitPong.transitions.Add(Events.event_Pong, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun6, Main_Ping_WaitPong, false);
