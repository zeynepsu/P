...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            {
                event_Success = new PrtEventValue(new PrtEvent("Success", Types.type_4_206682482, PrtEvent.DefaultMaxInstances, false));
                event_Pong = new PrtEventValue(new PrtEvent("Pong", Types.type_4_206682482, 1, false));
                event_Ping = new PrtEventValue(new PrtEvent("Ping", Types.type_M, 1, false));
            }
        }

        public partial class Types
        {
            public static PrtType type_M;
            public static PrtType type_1_206682482;
            public static PrtType type_2_206682482;
            public static PrtType type_3_206682482;
            public static PrtType type_4_206682482;
            public static PrtType type_PONG;
            public static PrtType type_Main;
            static public void Types_pingpongmonitor()
            {
                Types.type_M = new PrtMachineType();
                Types.type_1_206682482 = new PrtEventType();
                Types.type_2_206682482 = new PrtIntType();
                Types.type_3_206682482 = new PrtBoolType();
                Types.type_4_206682482 = new PrtNullType();
                Types.type_PONG = Types.type_M;
                Types.type_Main = Types.type_M;
            }
        }
        ...
        public class M : PrtSpecMachine
        {
            ...
            static M()
            {
                M_ExpectPong = new M_ExpectPong_Class("M_ExpectPong", AnonFun0, AnonFun1, false, StateTemperature.Hot);
                M_ExpectPing = new M_ExpectPing_Class("M_ExpectPing", AnonFun3, AnonFun4, false, StateTemperature.Cold);
        ...
        public class PONG : PrtImplMachine
        {
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\pingpongmonitor\\\\pingpongmonitor.p(40,7,40,12): error PC1001: Raised event must be non-null");
            ...
            static PONG()
            {
                ...
                PONG_Pong_WaitPing = new PONG_Pong_WaitPing_Class("PONG_Pong_WaitPing", AnonFun5, AnonFun6, false, StateTemperature.Warm);
                PrtTransition transition_1 = new PrtTransition(AnonFun4, PONG_Pong_WaitPing, false);
                PONG_Pong_SendPong.transitions.Add(Events.event_Success, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun7, PONG_Pong_SendPong, false);
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_M));
            }
            ...
            public class AnonFun4_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun4_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\pingpongmonitor\\\\pingpongmonitor.p(19,6,19,11): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            public class AnonFun6_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun6_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\pingpongmonitor\\\\pingpongmonitor.p(11,6,11,11): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            static Main()
            {
                ...
                Main_Ping_SendPing = new Main_Ping_SendPing_Class("Main_Ping_SendPing", AnonFun4, AnonFun5, false, StateTemperature.Warm);
                Main_Ping_Init = new Main_Ping_Init_Class("Main_Ping_Init", AnonFun6, AnonFun7, false, StateTemperature.Warm);
                PrtTransition transition_1 = new PrtTransition(AnonFun10, Main_Ping_SendPing, false);
                Main_Ping_WaitPong.transitions.Add(Events.event_Pong, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun11, Main_Ping_WaitPong, false);
                Main_Ping_SendPing.transitions.Add(Events.event_Success, transition_2);
                PrtTransition transition_3 = new PrtTransition(AnonFun12, Main_Ping_SendPing, false);
