...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_german_1_unbounded()
            {
                event_ask_share = new PrtEventValue(new PrtEvent("ask_share", Types.type_8_1295681653, PrtEvent.DefaultMaxInstances, false));
                event_ask_excl = new PrtEventValue(new PrtEvent("ask_excl", Types.type_8_1295681653, PrtEvent.DefaultMaxInstances, false));
                event_req_share = new PrtEventValue(new PrtEvent("req_share", Types.type_Client, 3, false));
                event_req_excl = new PrtEventValue(new PrtEvent("req_excl", Types.type_Client, 3, false));
                event_invalidate_ack = new PrtEventValue(new PrtEvent("invalidate_ack", Types.type_8_1295681653, 3, false));
                event_invalidate = new PrtEventValue(new PrtEvent("invalidate", Types.type_8_1295681653, 1, false));
                event_grant_excl = new PrtEventValue(new PrtEvent("grant_excl", Types.type_8_1295681653, 1, false));
                event_grant_share = new PrtEventValue(new PrtEvent("grant_share", Types.type_8_1295681653, 1, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_2_1295681653;
            public static PrtType type_1_1295681653;
            public static PrtType type_4_1295681653;
            public static PrtType type_3_1295681653;
            public static PrtType type_5_1295681653;
            public static PrtType type_6_1295681653;
            public static PrtType type_7_1295681653;
            public static PrtType type_8_1295681653;
            public static PrtType type_Main;
            public static PrtType type_CPU;
            static public void Types_german_1_unbounded()
            {
                Types.type_Client = new PrtMachineType();
                Types.type_2_1295681653 = new PrtIntType();
                Types.type_1_1295681653 = new PrtTupleType(new PrtType[]{Types.type_2_1295681653, Types.type_Client});
                Types.type_4_1295681653 = new PrtBoolType();
                Types.type_3_1295681653 = new PrtTupleType(new PrtType[]{Types.type_Client, Types.type_4_1295681653});
                Types.type_5_1295681653 = new PrtTupleType(new PrtType[]{Types.type_Client});
                Types.type_6_1295681653 = new PrtSeqType(Types.type_Client);
                Types.type_7_1295681653 = new PrtEventType();
                Types.type_8_1295681653 = new PrtNullType();
                Types.type_Main = Types.type_Client;
                Types.type_CPU = Types.type_Client;
            }
        }
        ...
        public class CPU : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_1295681653));
            }
            ...
            static CPU()
            {
                CPU_makeReq = new CPU_makeReq_Class("CPU_makeReq", AnonFun5, AnonFun3, false, StateTemperature.Warm);
                CPU_init = new CPU_init_Class("CPU_init", AnonFun4, AnonFun2, false, StateTemperature.Warm);
            }
        }
        ...
        public class Client : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Client));
            }
            ...
            static Client()
            {
                ...
                Client_sharing = new Client_sharing_Class("Client_sharing", AnonFun21, AnonFun22, false, StateTemperature.Warm);
                Client_invalid = new Client_invalid_Class("Client_invalid", AnonFun36, AnonFun40, false, StateTemperature.Warm);
                Client_invalidating = new Client_invalidating_Class("Client_invalidating", AnonFun35, AnonFun31, false, StateTemperature.Warm);
                Client_asked_ex2 = new Client_asked_ex2_Class("Client_asked_ex2", AnonFun46, AnonFun47, false, StateTemperature.Warm);
                Client_asked_excl = new Client_asked_excl_Class("Client_asked_excl", AnonFun32, AnonFun30, false, StateTemperature.Warm);
                Client_asked_share = new Client_asked_share_Class("Client_asked_share", AnonFun28, AnonFun29, false, StateTemperature.Warm);
                Client_init = new Client_init_Class("Client_init", AnonFun27, AnonFun26, false, StateTemperature.Warm);
                ...
                PrtTransition transition_5 = new PrtTransition(AnonFun19, Client_sharing_wait, false);
                Client_sharing_wait.transitions.Add(Events.event_grant_share, transition_5);
                PrtTransition transition_6 = new PrtTransition(AnonFun20, Client_invalidating, false);
                ...
                PrtTransition transition_7 = new PrtTransition(AnonFun42, Client_sharing, false);
                Client_invalid_wait.transitions.Add(Events.event_grant_share, transition_7);
                PrtTransition transition_8 = new PrtTransition(AnonFun45, Client_exclusive, false);
                Client_invalid_wait.transitions.Add(Events.event_grant_excl, transition_8);
                PrtTransition transition_9 = new PrtTransition(AnonFun37, Client_invalidating, false);
                Client_invalid_wait.transitions.Add(Events.event_invalidate, transition_9);
                PrtTransition transition_10 = new PrtTransition(AnonFun23, Client_asked_ex2, false);
                Client_sharing.transitions.Add(Events.event_ask_excl, transition_10);
                PrtTransition transition_11 = new PrtTransition(AnonFun24, Client_sharing, false);
                Client_sharing.transitions.Add(Events.event_ask_share, transition_11);
                PrtTransition transition_12 = new PrtTransition(AnonFun25, Client_exclusive, false);
                Client_sharing.transitions.Add(Events.event_grant_excl, transition_12);
                PrtTransition transition_13 = new PrtTransition(AnonFun44, Client_sharing, false);
                Client_sharing.transitions.Add(Events.event_grant_share, transition_13);
                PrtTransition transition_14 = new PrtTransition(AnonFun43, Client_invalidating, false);
                Client_sharing.transitions.Add(Events.event_invalidate, transition_14);
                PrtTransition transition_15 = new PrtTransition(AnonFun39, Client_sharing, false);
                Client_invalid.transitions.Add(Events.event_grant_share, transition_15);
                PrtTransition transition_16 = new PrtTransition(AnonFun38, Client_exclusive, false);
                Client_invalid.transitions.Add(Events.event_grant_excl, transition_16);
                PrtTransition transition_17 = new PrtTransition(AnonFun41, Client_invalidating, false);
                Client_invalid.transitions.Add(Events.event_invalidate, transition_17);
                PrtTransition transition_18 = new PrtTransition(AnonFun33, Client_asked_excl, false);
                Client_invalid.transitions.Add(Events.event_ask_excl, transition_18);
                PrtTransition transition_19 = new PrtTransition(AnonFun34, Client_asked_share, false);
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Client));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_2_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_2_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_6_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Client));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_1295681653));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Client));
            }
            ...
            public class AnonFun20_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!((PrtBoolValue)(new PrtBoolValue((new PrtIntValue(((parent).var_sharer_list).Size())).Equals(new PrtIntValue(0))))).bl)
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\german\\\\german_1_unbounded.p(43,4,43,10): error PC1001: Assert failed");
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_receiveState).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_receiveState;
            ...
            static Main()
            {
                ...
                Main_ProcessReq = new Main_ProcessReq_Class("Main_ProcessReq", AnonFun17, AnonFun14, false, StateTemperature.Warm);
                Main_ExclRequest = new Main_ExclRequest_Class("Main_ExclRequest", AnonFun15, AnonFun13, false, StateTemperature.Warm);
                Main_ShareRequest = new Main_ShareRequest_Class("Main_ShareRequest", AnonFun16, AnonFun12, false, StateTemperature.Warm);
                Main_init = new Main_init_Class("Main_init", AnonFun20, AnonFun11, false, StateTemperature.Warm);
                ...
                PrtTransition transition_2 = new PrtTransition(AnonFun21, Main_ShareRequest, false);
