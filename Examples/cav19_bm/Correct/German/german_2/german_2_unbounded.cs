...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_german_2_unbounded()
            {
                event_ask_share = new PrtEventValue(new PrtEvent("ask_share", Types.type_8_997776858, PrtEvent.DefaultMaxInstances, false));
                event_ask_excl = new PrtEventValue(new PrtEvent("ask_excl", Types.type_8_997776858, PrtEvent.DefaultMaxInstances, false));
                event_req_share = new PrtEventValue(new PrtEvent("req_share", Types.type_Main, PrtEvent.DefaultMaxInstances, false));
                event_req_excl = new PrtEventValue(new PrtEvent("req_excl", Types.type_Main, PrtEvent.DefaultMaxInstances, false));
                event_invalidate_ack = new PrtEventValue(new PrtEvent("invalidate_ack", Types.type_8_997776858, PrtEvent.DefaultMaxInstances, false));
                event_invalidate = new PrtEventValue(new PrtEvent("invalidate", Types.type_8_997776858, PrtEvent.DefaultMaxInstances, false));
                event_grant_excl = new PrtEventValue(new PrtEvent("grant_excl", Types.type_8_997776858, PrtEvent.DefaultMaxInstances, false));
                event_grant_share = new PrtEventValue(new PrtEvent("grant_share", Types.type_8_997776858, PrtEvent.DefaultMaxInstances, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_2_997776858;
            public static PrtType type_1_997776858;
            public static PrtType type_4_997776858;
            public static PrtType type_3_997776858;
            public static PrtType type_5_997776858;
            public static PrtType type_6_997776858;
            public static PrtType type_7_997776858;
            public static PrtType type_8_997776858;
            public static PrtType type_Client;
            public static PrtType type_CPU;
            static public void Types_german_2_unbounded()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_2_997776858 = new PrtIntType();
                Types.type_1_997776858 = new PrtTupleType(new PrtType[]{Types.type_2_997776858, Types.type_Main});
                Types.type_4_997776858 = new PrtBoolType();
                Types.type_3_997776858 = new PrtTupleType(new PrtType[]{Types.type_Main, Types.type_4_997776858});
                Types.type_5_997776858 = new PrtTupleType(new PrtType[]{Types.type_Main, Types.type_Main});
                Types.type_6_997776858 = new PrtSeqType(Types.type_Main);
                Types.type_7_997776858 = new PrtEventType();
                Types.type_8_997776858 = new PrtNullType();
                Types.type_Client = Types.type_Main;
                Types.type_CPU = Types.type_Main;
            }
        }
        ...
        public class CPU : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_997776858));
            }
        ...
        public class Client : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_997776858));
            ...
            static Client()
            {
                ...
                Client_invalid = new Client_invalid_Class("Client_invalid", AnonFun38, AnonFun37, false, StateTemperature.Warm);
                Client_invalidating = new Client_invalidating_Class("Client_invalidating", AnonFun41, AnonFun32, false, StateTemperature.Warm);
                Client_asked_ex2 = new Client_asked_ex2_Class("Client_asked_ex2", AnonFun46, AnonFun47, false, StateTemperature.Warm);
                Client_asked_excl = new Client_asked_excl_Class("Client_asked_excl", AnonFun30, AnonFun29, false, StateTemperature.Warm);
                Client_asked_share = new Client_asked_share_Class("Client_asked_share", AnonFun28, AnonFun31, false, StateTemperature.Warm);
                ...
                PrtTransition transition_7 = new PrtTransition(AnonFun45, Client_sharing, false);
                Client_invalid_wait.transitions.Add(Events.event_grant_share, transition_7);
                PrtTransition transition_8 = new PrtTransition(AnonFun44, Client_exclusive, false);
                Client_invalid_wait.transitions.Add(Events.event_grant_excl, transition_8);
                PrtTransition transition_9 = new PrtTransition(AnonFun35, Client_invalidating, false);
                ...
                PrtTransition transition_13 = new PrtTransition(AnonFun43, Client_sharing, false);
                Client_sharing.transitions.Add(Events.event_grant_share, transition_13);
                PrtTransition transition_14 = new PrtTransition(AnonFun42, Client_invalidating, false);
                Client_sharing.transitions.Add(Events.event_invalidate, transition_14);
                PrtTransition transition_15 = new PrtTransition(AnonFun36, Client_sharing, false);
                Client_invalid.transitions.Add(Events.event_grant_share, transition_15);
                PrtTransition transition_16 = new PrtTransition(AnonFun40, Client_exclusive, false);
                Client_invalid.transitions.Add(Events.event_grant_excl, transition_16);
                PrtTransition transition_17 = new PrtTransition(AnonFun39, Client_invalidating, false);
                Client_invalid.transitions.Add(Events.event_invalidate, transition_17);
                PrtTransition transition_18 = new PrtTransition(AnonFun34, Client_asked_excl, false);
                Client_invalid.transitions.Add(Events.event_ask_excl, transition_18);
                PrtTransition transition_19 = new PrtTransition(AnonFun33, Client_asked_share, false);
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Main));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_2_997776858));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_2_997776858));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_997776858));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_997776858));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_6_997776858));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Main));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_997776858));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_Main));
            }
            ...
            public class AnonFun22_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!((PrtBoolValue)(new PrtBoolValue((new PrtIntValue(((parent).var_sharer_list).Size())).Equals(new PrtIntValue(0))))).bl)
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\german\\\\german_2\\\\german_2_unbounded.p(38,4,38,10): error PC1001: Assert failed");
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_receiveState).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_receiveState;
            ...
            static Main()
            {
                ...
                Main_grantAccess = new Main_grantAccess_Class("Main_grantAccess", AnonFun19, AnonFun16, false, StateTemperature.Warm);
                Main_ProcessReq = new Main_ProcessReq_Class("Main_ProcessReq", AnonFun17, AnonFun13, false, StateTemperature.Warm);
                Main_ExclRequest = new Main_ExclRequest_Class("Main_ExclRequest", AnonFun18, AnonFun14, false, StateTemperature.Warm);
                Main_ShareRequest = new Main_ShareRequest_Class("Main_ShareRequest", AnonFun15, AnonFun11, false, StateTemperature.Warm);
                Main_init = new Main_init_Class("Main_init", AnonFun22, AnonFun12, false, StateTemperature.Warm);
                ...
                PrtTransition transition_1 = new PrtTransition(AnonFun20, Main_ExclRequest, false);
