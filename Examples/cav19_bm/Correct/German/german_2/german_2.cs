...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static PrtEventValue event_req_share;
            public static PrtEventValue event_req_excl;
            public static PrtEventValue event_need_invalidate;
            public static PrtEventValue event_invalidate_ack;
            public static PrtEventValue event_grant;
            public static PrtEventValue event_ask_share;
            public static PrtEventValue event_ask_excl;
            public static PrtEventValue event_invalidate;
            public static PrtEventValue event_grant_excl;
            public static PrtEventValue event_grant_share;
            public static PrtEventValue event_normal;
            public static PrtEventValue event_wait;
            public static PrtEventValue event_invalidate_sharers;
            public static PrtEventValue event_sharer_id;
            public static void Events_german_2()
            {
                event_unit = new PrtEventValue(new PrtEvent("unit", Types.type_8_413113789, 1, false));
                event_req_share = new PrtEventValue(new PrtEvent("req_share", Types.type_CPU, 3, false));
                event_req_excl = new PrtEventValue(new PrtEvent("req_excl", Types.type_CPU, 3, false));
                event_need_invalidate = new PrtEventValue(new PrtEvent("need_invalidate", Types.type_8_413113789, 1, false));
                event_invalidate_ack = new PrtEventValue(new PrtEvent("invalidate_ack", Types.type_8_413113789, 3, false));
                event_grant = new PrtEventValue(new PrtEvent("grant", Types.type_8_413113789, 1, false));
                event_ask_share = new PrtEventValue(new PrtEvent("ask_share", Types.type_8_413113789, 1, true));
                event_ask_excl = new PrtEventValue(new PrtEvent("ask_excl", Types.type_8_413113789, 1, true));
                event_invalidate = new PrtEventValue(new PrtEvent("invalidate", Types.type_8_413113789, 1, false));
                event_grant_excl = new PrtEventValue(new PrtEvent("grant_excl", Types.type_8_413113789, 1, false));
                event_grant_share = new PrtEventValue(new PrtEvent("grant_share", Types.type_8_413113789, 1, false));
                event_normal = new PrtEventValue(new PrtEvent("normal", Types.type_8_413113789, 1, false));
                event_wait = new PrtEventValue(new PrtEvent("wait", Types.type_8_413113789, 1, false));
                event_invalidate_sharers = new PrtEventValue(new PrtEvent("invalidate_sharers", Types.type_6_413113789, 1, false));
                event_sharer_id = new PrtEventValue(new PrtEvent("sharer_id", Types.type_CPU, 3, false));
            }
        }

        public partial class Types
        {
            public static PrtType type_CPU;
            public static PrtType type_1_413113789;
            public static PrtType type_3_413113789;
            public static PrtType type_2_413113789;
            public static PrtType type_4_413113789;
            public static PrtType type_6_413113789;
            public static PrtType type_5_413113789;
            public static PrtType type_7_413113789;
            public static PrtType type_8_413113789;
            public static PrtType type_Client;
            public static PrtType type_Main;
            static public void Types_german_2()
            {
                Types.type_CPU = new PrtMachineType();
                Types.type_1_413113789 = new PrtTupleType(new PrtType[]{Types.type_CPU, Types.type_CPU});
                Types.type_3_413113789 = new PrtBoolType();
                Types.type_2_413113789 = new PrtTupleType(new PrtType[]{Types.type_CPU, Types.type_3_413113789});
                Types.type_4_413113789 = new PrtSeqType(Types.type_CPU);
                Types.type_6_413113789 = new PrtIntType();
                Types.type_5_413113789 = new PrtTupleType(new PrtType[]{Types.type_6_413113789, Types.type_CPU});
                Types.type_7_413113789 = new PrtEventType();
                Types.type_8_413113789 = new PrtNullType();
                Types.type_Client = Types.type_CPU;
                Types.type_Main = Types.type_CPU;
            }
        }

        public static PrtImplMachine CreateMachine_CPU(StateImpl application, PrtValue payload)
        {
            var machine = new CPU(application, PrtImplMachine.DefaultMaxBufferSize, false);
        ...
        public class CPU : PrtImplMachine
        {
            ...
            public CPU(StateImpl app, int maxB, bool assume): base (app, maxB, assume)
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_1_413113789));
            }
            ...
            public class AnonFun4_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtValue swap;
                    (parent).var_cache = ((currFun).var_payload).Clone();
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (CPU_makeReq).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = CPU_makeReq;
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[0]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_ask_share), Events.@null, parent, (PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[0]).Clone()));
                    ...
                    AnonFun5_if_0_else:
                        ;
                    (((PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[0]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_ask_excl), Events.@null, parent, (PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[0]).Clone()));
                    ...
                    (((PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[1]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_ask_share), Events.@null, parent, (PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[1]).Clone()));
                    ...
                    AnonFun5_if_1_else:
                        ;
                    (((PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[1]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_ask_excl), Events.@null, parent, (PrtMachineValue)((((PrtTupleValue)((parent).var_cache)).fieldValues[1]).Clone()));
            ...
            public class CPU_makeReq_Class : PrtState
            {
                public CPU_makeReq_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static CPU_makeReq_Class CPU_makeReq;
            public class CPU_init_Class : PrtState
            {
                public CPU_init_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static CPU_init_Class CPU_init;
            static CPU()
            {
                CPU_makeReq = new CPU_makeReq_Class("CPU_makeReq", AnonFun5, AnonFun2, false, StateTemperature.Warm);
                CPU_init = new CPU_init_Class("CPU_init", AnonFun4, AnonFun3, false, StateTemperature.Warm);
            }
        }
        ...
        public class Client : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_CPU));
            }
            ...
            public class AnonFun0_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun0_StackFrame currFun = (AnonFun0_StackFrame)(parent.PrtPopFunStackFrame());
                    PrtValue swap;
                    (parent).var_pending = (new PrtBoolValue(false)).Clone();
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class AnonFun20_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtValue swap;
                    (parent).var_host = ((((PrtTupleValue)((currFun).var_payload)).fieldValues[0]).Clone()).Clone();
                    (parent).var_pending = ((((PrtTupleValue)((currFun).var_payload)).fieldValues[1]).Clone()).Clone();
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Client_invalid).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Client_invalid;
                    (parent).PrtFunContGoto();
                    return;
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class AnonFun23_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_host)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_req_excl), parent.self, parent, (PrtMachineValue)((parent).var_host));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun23_1:
                        ;
                    (parent).var_pending = (new PrtBoolValue(true)).Clone();
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Client_invalid_wait).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Client_invalid_wait;
                    (parent).PrtFunContGoto();
                    return;
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class AnonFun25_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_host)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_req_share), parent.self, parent, (PrtMachineValue)((parent).var_host));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun25_1:
                        ;
            ...
            public class AnonFun30_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_host)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_invalidate_ack), Events.@null, parent, (PrtMachineValue)((parent).var_host));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun30_1:
                        ;
                    if (!((PrtBoolValue)((parent).var_pending)).bl)
            ...
            public class AnonFun46_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun46_1:
                        ;
                    (parent).var_pending = (new PrtBoolValue(true)).Clone();
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Client_sharing_wait).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Client_sharing_wait;
                    (parent).PrtFunContGoto();
                    return;
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class Client_exclusive_Class : PrtState
            {
                public Client_exclusive_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_exclusive_Class Client_exclusive;
            public class Client_sharing_wait_Class : PrtState
            {
                public Client_sharing_wait_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_sharing_wait_Class Client_sharing_wait;
            public class Client_invalid_wait_Class : PrtState
            {
                public Client_invalid_wait_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_invalid_wait_Class Client_invalid_wait;
            public class Client_sharing_Class : PrtState
            {
                public Client_sharing_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_sharing_Class Client_sharing;
            public class Client_invalid_Class : PrtState
            {
                public Client_invalid_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_invalid_Class Client_invalid;
            public class Client_invalidating_Class : PrtState
            {
                public Client_invalidating_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_invalidating_Class Client_invalidating;
            public class Client_asked_ex2_Class : PrtState
            {
                public Client_asked_ex2_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_asked_ex2_Class Client_asked_ex2;
            public class Client_asked_excl_Class : PrtState
            {
                public Client_asked_excl_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_asked_excl_Class Client_asked_excl;
            public class Client_asked_share_Class : PrtState
            {
                public Client_asked_share_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Client_asked_share_Class Client_asked_share;
            ...
            static Client()
            {
                Client_exclusive = new Client_exclusive_Class("Client_exclusive", AnonFun0, AnonFun1, false, StateTemperature.Warm);
                Client_sharing_wait = new Client_sharing_wait_Class("Client_sharing_wait", AnonFun2, AnonFun3, false, StateTemperature.Warm);
                Client_invalid_wait = new Client_invalid_wait_Class("Client_invalid_wait", AnonFun4, AnonFun5, false, StateTemperature.Warm);
                Client_sharing = new Client_sharing_Class("Client_sharing", AnonFun44, AnonFun45, false, StateTemperature.Warm);
                Client_invalid = new Client_invalid_Class("Client_invalid", AnonFun29, AnonFun33, false, StateTemperature.Warm);
                Client_invalidating = new Client_invalidating_Class("Client_invalidating", AnonFun30, AnonFun24, false, StateTemperature.Warm);
                Client_asked_ex2 = new Client_asked_ex2_Class("Client_asked_ex2", AnonFun46, AnonFun47, false, StateTemperature.Warm);
                Client_asked_excl = new Client_asked_excl_Class("Client_asked_excl", AnonFun23, AnonFun22, false, StateTemperature.Warm);
                Client_asked_share = new Client_asked_share_Class("Client_asked_share", AnonFun25, AnonFun21, false, StateTemperature.Warm);
                Client_init = new Client_init_Class("Client_init", AnonFun20, AnonFun19, false, StateTemperature.Warm);
                Client_exclusive.dos.Add(Events.event_ask_excl, PrtFun.IgnoreFun);
                Client_exclusive.dos.Add(Events.event_ask_share, PrtFun.IgnoreFun);
                PrtTransition transition_1 = new PrtTransition(AnonFun15, Client_exclusive, false);
                Client_exclusive.transitions.Add(Events.event_grant_excl, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun16, Client_sharing, false);
                Client_exclusive.transitions.Add(Events.event_grant_share, transition_2);
                PrtTransition transition_3 = new PrtTransition(AnonFun17, Client_invalidating, false);
                Client_exclusive.transitions.Add(Events.event_invalidate, transition_3);
                Client_sharing_wait.deferredSet.Add(Events.event_ask_excl);
                Client_sharing_wait.deferredSet.Add(Events.event_ask_share);
                PrtTransition transition_4 = new PrtTransition(AnonFun18, Client_exclusive, false);
                Client_sharing_wait.transitions.Add(Events.event_grant_excl, transition_4);
                PrtTransition transition_5 = new PrtTransition(AnonFun40, Client_sharing_wait, false);
                Client_sharing_wait.transitions.Add(Events.event_grant_share, transition_5);
                PrtTransition transition_6 = new PrtTransition(AnonFun39, Client_invalidating, false);
                Client_sharing_wait.transitions.Add(Events.event_invalidate, transition_6);
                Client_invalid_wait.deferredSet.Add(Events.event_ask_excl);
                Client_invalid_wait.deferredSet.Add(Events.event_ask_share);
                PrtTransition transition_7 = new PrtTransition(AnonFun36, Client_sharing, false);
                Client_invalid_wait.transitions.Add(Events.event_grant_share, transition_7);
                PrtTransition transition_8 = new PrtTransition(AnonFun38, Client_exclusive, false);
                Client_invalid_wait.transitions.Add(Events.event_grant_excl, transition_8);
                PrtTransition transition_9 = new PrtTransition(AnonFun28, Client_invalidating, false);
                Client_invalid_wait.transitions.Add(Events.event_invalidate, transition_9);
                PrtTransition transition_10 = new PrtTransition(AnonFun42, Client_asked_ex2, false);
                Client_sharing.transitions.Add(Events.event_ask_excl, transition_10);
                PrtTransition transition_11 = new PrtTransition(AnonFun41, Client_sharing, false);
                Client_sharing.transitions.Add(Events.event_ask_share, transition_11);
                PrtTransition transition_12 = new PrtTransition(AnonFun43, Client_exclusive, false);
                Client_sharing.transitions.Add(Events.event_grant_excl, transition_12);
                PrtTransition transition_13 = new PrtTransition(AnonFun34, Client_sharing, false);
                Client_sharing.transitions.Add(Events.event_grant_share, transition_13);
                PrtTransition transition_14 = new PrtTransition(AnonFun37, Client_invalidating, false);
                Client_sharing.transitions.Add(Events.event_invalidate, transition_14);
                PrtTransition transition_15 = new PrtTransition(AnonFun32, Client_sharing, false);
                Client_invalid.transitions.Add(Events.event_grant_share, transition_15);
                PrtTransition transition_16 = new PrtTransition(AnonFun31, Client_exclusive, false);
                Client_invalid.transitions.Add(Events.event_grant_excl, transition_16);
                PrtTransition transition_17 = new PrtTransition(AnonFun35, Client_invalidating, false);
                Client_invalid.transitions.Add(Events.event_invalidate, transition_17);
                PrtTransition transition_18 = new PrtTransition(AnonFun27, Client_asked_excl, false);
                Client_invalid.transitions.Add(Events.event_ask_excl, transition_18);
                PrtTransition transition_19 = new PrtTransition(AnonFun26, Client_asked_share, false);
                Client_invalid.transitions.Add(Events.event_ask_share, transition_19);
            }
        }
        ...
        public class Main : PrtImplMachine
        {
            ...
            public PrtValue var_is_excl_granted
            {
                get
                {
                    return fields[3];
            ...
            public PrtValue var_is_curr_req_excl
            {
                get
                {
                    return fields[4];
            ...
            public PrtValue var_sharer_list
            {
                get
                {
                    return fields[5];
            ...
            public PrtValue var_curr_client
            {
                get
                {
                    return fields[8];
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_CPU));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_6_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_6_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_CPU));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_1_413113789));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_CPU));
            }
            ...
            public static ignore_Class ignore = new ignore_Class();
            public class rec_ack_Class : PrtFun
            {
                public override bool IsAnonFun
                {
                    get
                ...
                internal class rec_ack_StackFrame : PrtFunStackFrame
                {
                    public rec_ack_StackFrame(PrtFun fun, List<PrtValue> _locals): base (fun, _locals)
                    {
                    }

                    public rec_ack_StackFrame(PrtFun fun, List<PrtValue> _locals, int retLocation): base (fun, _locals, retLocation)
                    {
                    }
                ...
                {
                    Main parent = (Main)(_parent);
                    rec_ack_StackFrame currFun = (rec_ack_StackFrame)(parent.PrtPopFunStackFrame());
                    PrtValue swap;
                    ((PrtSeqValue)((parent).var_sharer_list)).Remove(new PrtIntValue(0));
                    (parent).var_s = (new PrtIntValue(((parent).var_sharer_list).Size())).Clone();
                    if (!((PrtBoolValue)(new PrtBoolValue(((parent).var_s).Equals(new PrtIntValue(0))))).bl)
                        goto rec_ack_if_0_else;
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_grantAccess).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_grantAccess;
                    (parent).PrtFunContGoto();
                    return;
                    goto rec_ack_if_0_end;
                    rec_ack_if_0_else:
                        ;
                    rec_ack_if_0_end:
                        ;
                ...
                public override PrtFunStackFrame CreateFunStackFrame(List<PrtValue> locals, int retLoc)
                {
                    return new rec_ack_StackFrame(this, locals, retLoc);
                }
            ...
            public static rec_ack_Class rec_ack = new rec_ack_Class();
            public class AnonFun0_Class : PrtFun
            {
                public override bool IsAnonFun
                {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun0_loop_start_0:
                        ;
                    if (!((PrtBoolValue)(new PrtBoolValue(((PrtIntValue)((parent).var_i)).nt < ((PrtIntValue)((parent).var_s)).nt))).bl)
                        goto AnonFun0_loop_end_0;
                    (((PrtMachineValue)((((PrtSeqValue)((parent).var_sharer_list)).Lookup((parent).var_i)).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_invalidate), Events.@null, parent, (PrtMachineValue)((((PrtSeqValue)((parent).var_sharer_list)).Lookup((parent).var_i)).Clone()));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun0_1:
                        ;
            ...
            public class AnonFun13_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun13_StackFrame currFun = (AnonFun13_StackFrame)(parent.PrtPopFunStackFrame());
                    PrtValue swap;
                    if (!((PrtBoolValue)(new PrtBoolValue(((PrtBoolValue)((parent).var_is_curr_req_excl)).bl || ((PrtBoolValue)((parent).var_is_excl_granted)).bl))).bl)
                        goto AnonFun13_if_0_else;
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_inv).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_inv;
                    (parent).PrtFunContGoto();
                    return;
            ...
            public class AnonFun14_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun14_StackFrame currFun = (AnonFun14_StackFrame)(parent.PrtPopFunStackFrame());
                    PrtValue swap;
                    (parent).var_curr_client = ((currFun).var_payload).Clone();
                    (parent).var_is_curr_req_excl = (new PrtBoolValue(false)).Clone();
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_ProcessReq).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_ProcessReq;
                    (parent).PrtFunContGoto();
                    return;
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class AnonFun15_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtValue swap;
                    (parent).var_curr_client = ((currFun).var_payload).Clone();
                    (parent).var_is_curr_req_excl = (new PrtBoolValue(true)).Clone();
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_ProcessReq).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_ProcessReq;
            ...
            public class AnonFun18_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!((PrtBoolValue)((parent).var_is_curr_req_excl)).bl)
                        goto AnonFun18_if_0_else;
                    (parent).var_is_excl_granted = (new PrtBoolValue(true)).Clone();
                    (((PrtMachineValue)((parent).var_curr_client)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_grant_excl), Events.@null, parent, (PrtMachineValue)((parent).var_curr_client));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun18_1:
                        ;
                    ...
                    AnonFun18_if_0_else:
                        ;
                    (((PrtMachineValue)((parent).var_curr_client)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_grant_share), Events.@null, parent, (PrtMachineValue)((parent).var_curr_client));
                    (parent).PrtFunContSend(this, (currFun).locals, 2);
                    return;
                    AnonFun18_2:
                        ;
                    AnonFun18_if_0_end:
                        ;
                    ((PrtSeqValue)((parent).var_sharer_list)).Insert(((PrtTupleValue)(new PrtTupleValue(new PrtIntValue(0), (parent).var_curr_client))).fieldValues[0], ((PrtTupleValue)(new PrtTupleValue(new PrtIntValue(0), (parent).var_curr_client))).fieldValues[1]);
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_receiveState).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_receiveState;
                    (parent).PrtFunContGoto();
                    return;
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class AnonFun21_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_temp = (application).CreateInterface(parent, "Client", new PrtTupleValue(parent.self, new PrtBoolValue(false)));
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 1);
                    return;
                    AnonFun21_1:
                        ;
                    ((PrtTupleValue)((parent).var_clients)).Update(0, ((parent).var_temp).Clone());
                    (parent).var_temp = (application).CreateInterface(parent, "Client", new PrtTupleValue(parent.self, new PrtBoolValue(false)));
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 2);
                    return;
                    AnonFun21_2:
                        ;
                    ((PrtTupleValue)((parent).var_clients)).Update(1, ((parent).var_temp).Clone());
                    (parent).var_curr_client = (Events.@null).Clone();
                    (parent).var_curr_cpu = (application).CreateInterface(parent, "CPU", (parent).var_clients);
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 3);
                    return;
                    AnonFun21_3:
                        ;
                    if (!((PrtBoolValue)(new PrtBoolValue((new PrtIntValue(((parent).var_sharer_list).Size())).Equals(new PrtIntValue(0))))).bl)
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\german\\\\german_2\\\\german_2.p(36,4,36,10): error PC1001: Assert failed");
                    (application).TraceLine("<GotoLog> Machine {0}-{1} goes to {2}", (parent).Name, (parent).instanceNumber, (Main_receiveState).name);
                    (parent).currentTrigger = Events.@null;
                    (parent).currentPayload = Events.@null;
                    (parent).destOfGoto = Main_receiveState;
            ...
            public static AnonFun22_Class AnonFun22 = new AnonFun22_Class();
            public class Main_inv_Class : PrtState
            {
                public Main_inv_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_inv_Class Main_inv;
            public class Main_receiveState_Class : PrtState
            {
                public Main_receiveState_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_receiveState_Class Main_receiveState;
            public class Main_grantAccess_Class : PrtState
            {
                public Main_grantAccess_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_grantAccess_Class Main_grantAccess;
            public class Main_ProcessReq_Class : PrtState
            {
                public Main_ProcessReq_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_ProcessReq_Class Main_ProcessReq;
            public class Main_ExclRequest_Class : PrtState
            {
                public Main_ExclRequest_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_ExclRequest_Class Main_ExclRequest;
            public class Main_ShareRequest_Class : PrtState
            {
                public Main_ShareRequest_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_ShareRequest_Class Main_ShareRequest;
            ...
            static Main()
            {
                Main_inv = new Main_inv_Class("Main_inv", AnonFun0, AnonFun1, false, StateTemperature.Warm);
                Main_receiveState = new Main_receiveState_Class("Main_receiveState", AnonFun2, AnonFun3, false, StateTemperature.Warm);
                Main_grantAccess = new Main_grantAccess_Class("Main_grantAccess", AnonFun18, AnonFun19, false, StateTemperature.Warm);
                Main_ProcessReq = new Main_ProcessReq_Class("Main_ProcessReq", AnonFun13, AnonFun16, false, StateTemperature.Warm);
                Main_ExclRequest = new Main_ExclRequest_Class("Main_ExclRequest", AnonFun15, AnonFun17, false, StateTemperature.Warm);
                Main_ShareRequest = new Main_ShareRequest_Class("Main_ShareRequest", AnonFun14, AnonFun12, false, StateTemperature.Warm);
                Main_init = new Main_init_Class("Main_init", AnonFun21, AnonFun11, false, StateTemperature.Warm);
                Main_inv.dos.Add(Events.event_invalidate_ack, rec_ack);
                Main_inv.deferredSet.Add(Events.event_req_excl);
                Main_inv.deferredSet.Add(Events.event_req_share);
                Main_receiveState.deferredSet.Add(Events.event_invalidate_ack);
                PrtTransition transition_1 = new PrtTransition(AnonFun22, Main_ExclRequest, false);
                Main_receiveState.transitions.Add(Events.event_req_excl, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun20, Main_ShareRequest, false);
                Main_receiveState.transitions.Add(Events.event_req_share, transition_2);
            }
        }
    }
}
