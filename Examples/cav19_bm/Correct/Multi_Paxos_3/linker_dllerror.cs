...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        ...
        static Application()
        {
            ...
            {"LeaderElection", "Timer", "Main", "BasicPaxosInvariant_P2b", "ValmachineityCheck", "Client", "PaxosNode"});
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_multi_paxos_3()
            {
                ...
                event_accept = new PrtEventValue(new PrtEvent("accept", Types.type_13_115039177, 3, true));
                event_agree = new PrtEventValue(new PrtEvent("agree", Types.type_14_115039177, 6, true));
                event_reject = new PrtEventValue(new PrtEvent("reject", Types.type_18_115039177, 6, true));
                event_accepted = new PrtEventValue(new PrtEvent("accepted", Types.type_14_115039177, 6, true));
                ...
                event_chosen = new PrtEventValue(new PrtEvent("chosen", Types.type_14_115039177, PrtEvent.DefaultMaxInstances, false));
                event_update = new PrtEventValue(new PrtEvent("update", Types.type_10_115039177, PrtEvent.DefaultMaxInstances, false));
                event_announce_valueChosen = new PrtEventValue(new PrtEvent("announce_valueChosen", Types.type_13_115039177, PrtEvent.DefaultMaxInstances, false));
                event_announce_valueProposed = new PrtEventValue(new PrtEvent("announce_valueProposed", Types.type_13_115039177, PrtEvent.DefaultMaxInstances, false));
                ...
                event_timeout = new PrtEventValue(new PrtEvent("timeout", Types.type_5_115039177, PrtEvent.DefaultMaxInstances, false));
        ...
        public partial class Types
        {
            ...
            static public void Types_multi_paxos_3()
            {
                ...
                Types.type_5_115039177 = new PrtNamedTupleType(new object[]{"mymachine", Types.type_ValmachineityCheck});
                Types.type_6_115039177 = new PrtTupleType(new PrtType[]{Types.type_ValmachineityCheck, Types.type_3_115039177});
                ...
                Types.type_13_115039177 = new PrtNamedTupleType(new object[]{"proposer", Types.type_ValmachineityCheck, "slot", Types.type_3_115039177, "proposal", Types.type_7_115039177, "value", Types.type_3_115039177});
                Types.type_14_115039177 = new PrtNamedTupleType(new object[]{"slot", Types.type_3_115039177, "proposal", Types.type_7_115039177, "value", Types.type_3_115039177});
                ...
                Types.type_18_115039177 = new PrtNamedTupleType(new object[]{"slot", Types.type_3_115039177, "proposal", Types.type_7_115039177});
                Types.type_19_115039177 = new PrtTupleType(new PrtType[]{Types.type_3_115039177, Types.type_ValmachineityCheck});
        ...
        public class Client : PrtImplMachine
        {
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_local).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\multi_paxos_3\\\\multi_paxos_3.p(540,4,540,9): error PC1001: Raised event must be non-null");
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_response).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\multi_paxos_3\\\\multi_paxos_3.p(554,4,554,9): error PC1001: Raised event must be non-null");
            ...
            public class AnonFun7_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun7_if_0_end:
                        ;
                    if (!!(Events.event_response).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\multi_paxos_3\\\\multi_paxos_3.p(568,4,568,9): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_response)).evt).name);
                    (parent).currentTrigger = Events.event_response;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            static Client()
            {
                Client_PumpRequestTwo = new Client_PumpRequestTwo_Class("Client_PumpRequestTwo", AnonFun7, AnonFun11, false, StateTemperature.Warm);
                Client_PumpRequestOne = new Client_PumpRequestOne_Class("Client_PumpRequestOne", AnonFun3, AnonFun9, false, StateTemperature.Warm);
                Client_Init = new Client_Init_Class("Client_Init", AnonFun2, AnonFun12, false, StateTemperature.Warm);
                Client_Done = new Client_Done_Class("Client_Done", AnonFun1, AnonFun0, false, StateTemperature.Warm);
                PrtTransition transition_1 = new PrtTransition(AnonFun10, Client_Done, false);
                ...
                PrtTransition transition_3 = new PrtTransition(AnonFun13, Client_PumpRequestOne, false);
        ...
        public class ValmachineityCheck : PrtSpecMachine
        {
            ...
            {
                ValmachineityCheck_Wait = new ValmachineityCheck_Wait_Class("ValmachineityCheck_Wait", AnonFun5, AnonFun6, false, StateTemperature.Warm);
                ...
                ValmachineityCheck_Wait.dos.Add(Events.event_announce_proposer_chosen, AnonFun3);
        ...
        public class BasicPaxosInvariant_P2b : PrtSpecMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_13_115039177));
            ...
            {
                BasicPaxosInvariant_P2b_WaitForValueChosen = new BasicPaxosInvariant_P2b_WaitForValueChosen_Class("BasicPaxosInvariant_P2b_WaitForValueChosen", AnonFun2, AnonFun9, false, StateTemperature.Warm);
                BasicPaxosInvariant_P2b_CheckValueProposed = new BasicPaxosInvariant_P2b_CheckValueProposed_Class("BasicPaxosInvariant_P2b_CheckValueProposed", AnonFun5, AnonFun4, false, StateTemperature.Warm);
                BasicPaxosInvariant_P2b_Init = new BasicPaxosInvariant_P2b_Init_Class("BasicPaxosInvariant_P2b_Init", AnonFun7, AnonFun6, false, StateTemperature.Warm);
                ...
                PrtTransition transition_3 = new PrtTransition(AnonFun3, BasicPaxosInvariant_P2b_CheckValueProposed, false);
        ...
        public class PaxosNode : PrtImplMachine
        {
            ...
            public class preparefun_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_agree), new PrtNamedTupleValue(Types.type_14_115039177, (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone(), new PrtNamedTupleValue(Types.type_7_115039177, new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt)), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt)), parent, (PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone()));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    preparefun_1:
                        ;
                    ...
                    (((PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_reject), new PrtNamedTupleValue(Types.type_18_115039177, (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone(), (((PrtTupleValue)((((PrtMapValue)((parent).var_acceptorSlots)).Lookup((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone())).Clone())).fieldValues[0]).Clone()), parent, (PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone()));
                    (parent).PrtFunContSend(this, (currFun).locals, 2);
                    return;
                    preparefun_2:
                        ;
            ...
            public class acceptfun_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_accepted), new PrtNamedTupleValue(Types.type_14_115039177, (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone(), (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[2]).Clone(), (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[3]).Clone()), parent, (PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone()));
                    (parent).PrtFunContSend(this, (currFun).locals, 2);
                    return;
                    acceptfun_2:
                        ;
            ...
            public class CountAccepted_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (application).Announce((PrtEventValue)(Events.event_announce_valueChosen), new PrtNamedTupleValue(Types.type_13_115039177, parent.self, (parent).var_nextSlotForProposer, (parent).var_nextProposal, (parent).var_proposeVal), parent);
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).PrtFunContRaise();
                    return;
                    goto AnonFun3_if_2_end;
                    AnonFun3_if_2_else:
                        ;
                    AnonFun3_if_2_end:
                        ;
                    goto AnonFun3_if_3_end;
                    AnonFun3_if_3_else:
                        ;
                    AnonFun3_if_3_end:
                        ;
            ...
            public class AnonFun11_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (application).Announce((PrtEventValue)(Events.event_announce_valueProposed), new PrtNamedTupleValue(Types.type_13_115039177, parent.self, (parent).var_nextSlotForProposer, (parent).var_nextProposal, (parent).var_proposeVal), parent);
                    (application).Announce((PrtEventValue)(Events.event_announce_proposer_sent), (parent).var_proposeVal, parent);
                    (parent).PrtPushFunStackFrame(BroadCastAcceptors, (BroadCastAcceptors).CreateLocals(Events.event_accept, new PrtNamedTupleValue(Types.type_13_115039177, parent.self, (parent).var_nextSlotForProposer, (parent).var_nextProposal, (parent).var_proposeVal)));
                    AnonFun11_2:
                        ;
            ...
            static PaxosNode()
            {
                PaxosNode_RunLearner = new PaxosNode_RunLearner_Class("PaxosNode_RunLearner", AnonFun2, AnonFun4, false, StateTemperature.Warm);
                PaxosNode_ProposeValuePhase2 = new PaxosNode_ProposeValuePhase2_Class("PaxosNode_ProposeValuePhase2", AnonFun11, AnonFun26, false, StateTemperature.Warm);
                PaxosNode_ProposeValuePhase1 = new PaxosNode_ProposeValuePhase1_Class("PaxosNode_ProposeValuePhase1", AnonFun13, AnonFun24, false, StateTemperature.Warm);
                PaxosNode_PerformOperation = new PaxosNode_PerformOperation_Class("PaxosNode_PerformOperation", AnonFun20, AnonFun19, false, StateTemperature.Warm);
                PaxosNode_Init = new PaxosNode_Init_Class("PaxosNode_Init", AnonFun5, AnonFun18, false, StateTemperature.Warm);
                ...
                PaxosNode_ProposeValuePhase2.dos.Add(Events.event_accepted, AnonFun7);
                PaxosNode_ProposeValuePhase2.dos.Add(Events.event_agree, PrtFun.IgnoreFun);
                PrtTransition transition_1 = new PrtTransition(AnonFun25, PaxosNode_ProposeValuePhase1, false);
                ...
                PaxosNode_ProposeValuePhase1.dos.Add(Events.event_agree, AnonFun3);
                PaxosNode_ProposeValuePhase1.dos.Add(Events.event_accepted, PrtFun.IgnoreFun);
                PrtTransition transition_3 = new PrtTransition(AnonFun23, PaxosNode_ProposeValuePhase1, false);
                PaxosNode_ProposeValuePhase1.transitions.Add(Events.event_timeout, transition_3);
                PrtTransition transition_4 = new PrtTransition(AnonFun22, PaxosNode_ProposeValuePhase2, false);
                PaxosNode_ProposeValuePhase1.transitions.Add(Events.event_success, transition_4);
                PrtTransition transition_5 = new PrtTransition(AnonFun1, PaxosNode_ProposeValuePhase1, false);
                PaxosNode_ProposeValuePhase1.transitions.Add(Events.event_reject, transition_5);
                PaxosNode_PerformOperation.dos.Add(Events.event_newLeader, AnonFun6);
                PaxosNode_PerformOperation.dos.Add(Events.event_Ping, AnonFun10);
                PaxosNode_PerformOperation.dos.Add(Events.event_accept, AnonFun9);
                PaxosNode_PerformOperation.dos.Add(Events.event_prepare, AnonFun8);
                PaxosNode_PerformOperation.dos.Add(Events.event_update, AnonFun12);
                ...
                PrtTransition transition_8 = new PrtTransition(AnonFun17, PaxosNode_PerformOperation, false);
