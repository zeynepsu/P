...
// // asserts the liveness monitor along with the default properties
// test Test2[main = TestDriver0]: assert Progress in { TestDriver0, Coordinator, Participant, Timer, Client };

// // asserts the atomicity monitor along with the default properties
// test Test3[main = TestDriver0]: assert Atomicity in { TestDriver0, Coordinator, Participant, Timer, Client };