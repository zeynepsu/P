...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_raisesendinentry()
            {
                event_E2 = new PrtEventValue(new PrtEvent("E2", Types.type_4_2058210145, 1, false));
                event_E1 = new PrtEventValue(new PrtEvent("E1", Types.type_4_2058210145, 1, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_2058210145;
            public static PrtType type_2_2058210145;
            public static PrtType type_3_2058210145;
            public static PrtType type_4_2058210145;
            static public void Types_raisesendinentry()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_2058210145 = new PrtIntType();
                Types.type_2_2058210145 = new PrtBoolType();
                Types.type_3_2058210145 = new PrtEventType();
                Types.type_4_2058210145 = new PrtNullType();
            }
        }
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_2_2058210145));
            }
            ...
            public class Action2_Class : PrtFun
            {
                ...
                {
                    public Action2_StackFrame(PrtFun fun, List<PrtValue> _locals): base (fun, _locals)
                    {
                    }

                    public Action2_StackFrame(PrtFun fun, List<PrtValue> _locals, int retLocation): base (fun, _locals, retLocation)
                    {
                    }
                ...
                {
                    Main parent = (Main)(_parent);
                    Action2_StackFrame currFun = (Action2_StackFrame)(parent.PrtPopFunStackFrame());
                    PrtValue swap;
                    if (!((PrtBoolValue)(new PrtBoolValue(((parent).var_XYZ).Equals(new PrtBoolValue(false))))).bl)
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\sem_onemachine_2\\\\raisesendinentry.p(22,3,22,9): error PC1001: Assert failed");
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public static Action2_Class Action2 = new Action2_Class();
            ...
            public class AnonFun0_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_E1).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\sem_onemachine_2\\\\raisesendinentry.p(10,4,10,9): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_E1)).evt).name);
                    (parent).currentTrigger = Events.event_E1;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
                    return;
                    (((PrtMachineValue)(parent.self)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_E2), Events.@null, parent, (PrtMachineValue)(parent.self));
            ...
            public class Main_Real1_Init_Class : PrtState
            {
                public Main_Real1_Init_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_Real1_Init_Class Main_Real1_Init;
            static Main()
            {
                Main_Real1_Init = new Main_Real1_Init_Class("Main_Real1_Init", AnonFun0, AnonFun1, false, StateTemperature.Warm);
                Main_Real1_Init.dos.Add(Events.event_E2, Action2);
                Main_Real1_Init.dos.Add(Events.event_E1, Action1);
            }
        }
    }
}
