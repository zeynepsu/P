...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static PrtEventValue event_PingIgnored;
            public static PrtEventValue event_Success;
            public static PrtEventValue event_Pong;
            public static void Events_eventsentaftersenthalt()
            {
                event_Ping = new PrtEventValue(new PrtEvent("Ping", Types.type_Main, 1, false));
                event_PingIgnored = new PrtEventValue(new PrtEvent("PingIgnored", Types.type_4_398530281, PrtEvent.DefaultMaxInstances, false));
                event_Success = new PrtEventValue(new PrtEvent("Success", Types.type_4_398530281, PrtEvent.DefaultMaxInstances, false));
                event_Pong = new PrtEventValue(new PrtEvent("Pong", Types.type_4_398530281, 1, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_398530281;
            public static PrtType type_2_398530281;
            public static PrtType type_3_398530281;
            public static PrtType type_4_398530281;
            public static PrtType type_PONG;
            static public void Types_eventsentaftersenthalt()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_398530281 = new PrtIntType();
                Types.type_2_398530281 = new PrtBoolType();
                Types.type_3_398530281 = new PrtEventType();
                Types.type_4_398530281 = new PrtNullType();
                Types.type_PONG = Types.type_Main;
            }
        }
        ...
        public class PONG : PrtImplMachine
        {
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!((PrtBoolValue)(new PrtBoolValue(false))).bl)
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\sem_twomachines_1\\\\eventsentaftersenthalt.p(48,23,48,29): error PC1001: Assert failed");
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\sem_twomachines_1\\\\eventsentaftersenthalt.p(54,7,54,12): error PC1001: Raised event must be non-null");
            ...
            static PONG()
            {
                ...
                PONG_Pong_SendPong = new PONG_Pong_SendPong_Class("PONG_Pong_SendPong", AnonFun5, AnonFun6, false, StateTemperature.Warm);
                PONG_Pong_WaitPing.dos.Add(Events.event_PingIgnored, AnonFun2);
                PrtTransition transition_1 = new PrtTransition(AnonFun8, PONG_Pong_SendPong, false);
                PONG_Pong_WaitPing.transitions.Add(Events.event_Ping, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun7, PONG_Pong_WaitPing, false);
                PONG_Pong_SendPong.transitions.Add(Events.event_Success, transition_2);
            }
        }
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_1_398530281));
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!((PrtBoolValue)(new PrtBoolValue(((parent).var_count).Equals(new PrtIntValue(1))))).bl)
                    ...
                    AnonFun5_if_0_end:
                        ;
                    if (!((PrtBoolValue)(new PrtBoolValue(((parent).var_count).Equals(new PrtIntValue(2))))).bl)
                        goto AnonFun5_if_1_else;
                    (((PrtMachineValue)((parent).var_pongId)).mach).PrtEnqueueEvent((PrtEventValue)(Events.halt), Events.@null, parent, (PrtMachineValue)((parent).var_pongId));
                    (parent).PrtFunContSend(this, (currFun).locals, 2);
                    return;
                    AnonFun5_2:
                        ;
                    (((PrtMachineValue)((parent).var_pongId)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_PingIgnored), Events.@null, parent, (PrtMachineValue)((parent).var_pongId));
                    ...
                    AnonFun5_if_1_end:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\sem_twomachines_1\\\\eventsentaftersenthalt.p(31,4,31,9): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            public class AnonFun8_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_pongId = (application).CreateInterface(parent, "PONG", Events.@null);
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 1);
                    return;
                    AnonFun8_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\sem_twomachines_1\\\\eventsentaftersenthalt.p(15,4,15,9): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            static Main()
            {
                ...
                Main_Ping_SendPing = new Main_Ping_SendPing_Class("Main_Ping_SendPing", AnonFun5, AnonFun6, false, StateTemperature.Warm);
                Main_Ping_Init = new Main_Ping_Init_Class("Main_Ping_Init", AnonFun8, AnonFun9, false, StateTemperature.Warm);
                Main_Done = new Main_Done_Class("Main_Done", AnonFun11, AnonFun12, false, StateTemperature.Warm);
                PrtTransition transition_1 = new PrtTransition(AnonFun4, Main_Ping_SendPing, false);
                Main_Ping_WaitPong.transitions.Add(Events.event_Pong, transition_1);
                PrtTransition transition_2 = new PrtTransition(AnonFun7, Main_Ping_WaitPong, false);
                Main_Ping_SendPing.transitions.Add(Events.event_Success, transition_2);
                PrtTransition transition_3 = new PrtTransition(AnonFun10, Main_Ping_SendPing, false);
