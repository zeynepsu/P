...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            {
                event_prepare = new PrtEventValue(new PrtEvent("prepare", Types.type_16_115039180, 3, true));
                ...
                event_allNodes = new PrtEventValue(new PrtEvent("allNodes", Types.type_6_115039180, PrtEvent.DefaultMaxInstances, false));
                ...
                event_update = new PrtEventValue(new PrtEvent("update", Types.type_8_115039180, PrtEvent.DefaultMaxInstances, false));
                ...
                event_announce_client_sent = new PrtEventValue(new PrtEvent("announce_client_sent", Types.type_3_115039180, PrtEvent.DefaultMaxInstances, false));
                event_announce_proposer_sent = new PrtEventValue(new PrtEvent("announce_proposer_sent", Types.type_3_115039180, PrtEvent.DefaultMaxInstances, false));
                event_announce_proposer_chosen = new PrtEventValue(new PrtEvent("announce_proposer_chosen", Types.type_3_115039180, PrtEvent.DefaultMaxInstances, false));
                ...
                event_timeout = new PrtEventValue(new PrtEvent("timeout", Types.type_15_115039180, PrtEvent.DefaultMaxInstances, false));
        ...
        public partial class Types
        {
            ...
            static public void Types_multi_paxos_4()
            {
                ...
                Types.type_3_115039180 = new PrtIntType();
                Types.type_2_115039180 = new PrtNamedTupleType(new object[]{"round", Types.type_3_115039180, "servermachine", Types.type_3_115039180});
                Types.type_1_115039180 = new PrtNamedTupleType(new object[]{"proposal", Types.type_2_115039180, "value", Types.type_3_115039180});
                Types.type_5_115039180 = new PrtSeqType(Types.type_ValmachineityCheck);
                Types.type_4_115039180 = new PrtNamedTupleType(new object[]{"servers", Types.type_5_115039180, "parentServer", Types.type_ValmachineityCheck, "rank", Types.type_3_115039180});
                Types.type_6_115039180 = new PrtNamedTupleType(new object[]{"nodes", Types.type_5_115039180});
                Types.type_7_115039180 = new PrtTupleType(new PrtType[]{Types.type_ValmachineityCheck, Types.type_3_115039180});
                Types.type_8_115039180 = new PrtNamedTupleType(new object[]{"seqmachine", Types.type_3_115039180, "command", Types.type_3_115039180});
                Types.type_9_115039180 = new PrtMapType(Types.type_3_115039180, Types.type_3_115039180);
                Types.type_10_115039180 = new PrtNamedTupleType(new object[]{"rank", Types.type_3_115039180, "server", Types.type_ValmachineityCheck});
                Types.type_11_115039180 = new PrtNamedTupleType(new object[]{"rank", Types.type_3_115039180});
                Types.type_12_115039180 = new PrtAnyType();
                Types.type_13_115039180 = new PrtTupleType(new PrtType[]{Types.type_3_115039180, Types.type_ValmachineityCheck});
                Types.type_14_115039180 = new PrtNamedTupleType(new object[]{"proposer", Types.type_ValmachineityCheck, "slot", Types.type_3_115039180, "proposal", Types.type_2_115039180, "value", Types.type_3_115039180});
                Types.type_15_115039180 = new PrtNamedTupleType(new object[]{"mymachine", Types.type_ValmachineityCheck});
                Types.type_16_115039180 = new PrtNamedTupleType(new object[]{"proposer", Types.type_ValmachineityCheck, "slot", Types.type_3_115039180, "proposal", Types.type_2_115039180});
                Types.type_17_115039180 = new PrtMapType(Types.type_3_115039180, Types.type_1_115039180);
                Types.type_18_115039180 = new PrtNamedTupleType(new object[]{"slot", Types.type_3_115039180, "proposal", Types.type_2_115039180, "value", Types.type_3_115039180});
                Types.type_19_115039180 = new PrtNamedTupleType(new object[]{"slot", Types.type_3_115039180, "proposal", Types.type_2_115039180});
        ...
        public class Client : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_115039180));
            }
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_local).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\multi_paxos_4\\\\multi_paxos_4.p(544,4,544,9): error PC1001: Raised event must be non-null");
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtSeqValue)((parent).var_servers)).Lookup(new PrtIntValue(0))).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_update), new PrtNamedTupleValue(Types.type_8_115039180, new PrtIntValue(0), new PrtIntValue(1)), parent, (PrtMachineValue)((((PrtSeqValue)((parent).var_servers)).Lookup(new PrtIntValue(0))).Clone()));
                    ...
                    AnonFun3_if_0_else:
                        ;
                    (((PrtMachineValue)((((PrtSeqValue)((parent).var_servers)).Lookup(new PrtIntValue(((PrtIntValue)(new PrtIntValue(((parent).var_servers).Size()))).nt - ((PrtIntValue)(new PrtIntValue(1))).nt))).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_update), new PrtNamedTupleValue(Types.type_8_115039180, new PrtIntValue(0), new PrtIntValue(1)), parent, (PrtMachineValue)((((PrtSeqValue)((parent).var_servers)).Lookup(new PrtIntValue(((PrtIntValue)(new PrtIntValue(((parent).var_servers).Size()))).nt - ((PrtIntValue)(new PrtIntValue(1))).nt))).Clone()));
                    ...
                    if (!!(Events.event_response).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\multi_paxos_4\\\\multi_paxos_4.p(558,4,558,9): error PC1001: Raised event must be non-null");
            ...
            public class AnonFun7_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtSeqValue)((parent).var_servers)).Lookup(new PrtIntValue(0))).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_update), new PrtNamedTupleValue(Types.type_8_115039180, new PrtIntValue(0), new PrtIntValue(2)), parent, (PrtMachineValue)((((PrtSeqValue)((parent).var_servers)).Lookup(new PrtIntValue(0))).Clone()));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun7_1:
                        ;
                    ...
                    AnonFun7_if_0_end:
                        ;
                    if (!!(Events.event_response).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\correct\\\\multi_paxos_4\\\\multi_paxos_4.p(572,4,572,9): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_response)).evt).name);
                    (parent).currentTrigger = Events.event_response;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            static Client()
            {
                ...
                Client_PumpRequestOne = new Client_PumpRequestOne_Class("Client_PumpRequestOne", AnonFun3, AnonFun8, false, StateTemperature.Warm);
                Client_Init = new Client_Init_Class("Client_Init", AnonFun2, AnonFun11, false, StateTemperature.Warm);
                ...
                PrtTransition transition_2 = new PrtTransition(AnonFun12, Client_PumpRequestTwo, false);
        ...
        public class Main : PrtImplMachine
        {
            ...
            public Main(StateImpl app, int maxB, bool assume): base (app, maxB, assume)
            {
                ...
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_115039180));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_ValmachineityCheck));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_115039180));
            }
            ...
            public class AnonFun1_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtSeqValue)((parent).var_paxosnodes)).Lookup((parent).var_iter)).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_allNodes), new PrtNamedTupleValue(Types.type_6_115039180, (parent).var_paxosnodes), parent, (PrtMachineValue)((((PrtSeqValue)((parent).var_paxosnodes)).Lookup((parent).var_iter)).Clone()));
        ...
        public class ValmachineityCheck : PrtSpecMachine
        {
            ...
            public class AnonFun0_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    ((PrtMapValue)((parent).var_ProposedSet)).Update(PrtValue.PrtCastValue((currFun).var_payload, Types.type_3_115039180), (new PrtIntValue(0)).Clone());
                    parent.PrtFunContReturn((currFun).locals);
                }
        ...
        public class BasicPaxosInvariant_P2b : PrtSpecMachine
        {
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun5_StackFrame currFun = (AnonFun5_StackFrame)(parent.PrtPopFunStackFrame());
                    PrtValue swap;
                    ((PrtMapValue)((parent).var_lastValueChosen)).Update((((PrtTupleValue)((currFun).var_receivedValue)).fieldValues[1]).Clone(), (new PrtNamedTupleValue(Types.type_1_115039180, (((PrtTupleValue)((currFun).var_receivedValue)).fieldValues[2]).Clone(), (((PrtTupleValue)((currFun).var_receivedValue)).fieldValues[3]).Clone())).Clone());
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            static BasicPaxosInvariant_P2b()
            {
                ...
                BasicPaxosInvariant_P2b_CheckValueProposed = new BasicPaxosInvariant_P2b_CheckValueProposed_Class("BasicPaxosInvariant_P2b_CheckValueProposed", AnonFun2, AnonFun4, false, StateTemperature.Warm);
        ...
        public class PaxosNode : PrtImplMachine
        {
            ...
            public PaxosNode(StateImpl app, int maxB, bool assume): base (app, maxB, assume)
            {
                ...
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_115039180));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_115039180));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_1_115039180));
            ...
            public class UpdateAcceptors_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_leaderElectionService = (application).CreateInterface(parent, "LeaderElection", new PrtNamedTupleValue(Types.type_4_115039180, (parent).var_acceptors, parent.self, (parent).var_myRank));
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 1);
                    return;
                    UpdateAcceptors_1:
                        ;
            ...
            public class preparefun_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone())).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_agree), new PrtNamedTupleValue(Types.type_18_115039180, (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone(), new PrtNamedTupleValue(Types.type_2_115039180, new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt)), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt)), parent, (PrtMachineValue)((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[0]).Clone()));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    preparefun_1:
                        ;
                    ((PrtMapValue)((parent).var_acceptorSlots)).Update((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone(), (new PrtNamedTupleValue(Types.type_1_115039180, (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[2]).Clone(), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt))).Clone());
                    (parent).PrtFunContReturn((currFun).locals);
                    return;
            ...
            public class GetNextProposal_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtValue swap;
                    (parent).PrtFunContReturnVal(new PrtNamedTupleValue(Types.type_2_115039180, new PrtIntValue(((PrtIntValue)((currFun).var_maxRound)).nt + ((PrtIntValue)(new PrtIntValue(1))).nt), (parent).var_myRank), (currFun).locals);
                    return;
                    parent.PrtFunContReturn((currFun).locals);
                }
            ...
            public class acceptfun_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    acceptfun_if_0_else:
                        ;
                    ((PrtMapValue)((parent).var_acceptorSlots)).Update((((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[1]).Clone(), (new PrtNamedTupleValue(Types.type_1_115039180, (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[2]).Clone(), (((PrtTupleValue)((currFun).var_receivedMess_2)).fieldValues[3]).Clone())).Clone());
            ...
            public class AnonFun1_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    ((PrtMapValue)((parent).var_learnerSlots)).Update((((PrtTupleValue)((currFun).var_receivedMess_1)).fieldValues[0]).Clone(), (new PrtNamedTupleValue(Types.type_1_115039180, (((PrtTupleValue)((currFun).var_receivedMess_1)).fieldValues[1]).Clone(), (((PrtTupleValue)((currFun).var_receivedMess_1)).fieldValues[2]).Clone())).Clone());
            ...
            public class AnonFun9_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_receivedAgree = (new PrtNamedTupleValue(Types.type_1_115039180, new PrtNamedTupleValue(Types.type_2_115039180, new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt)), new PrtIntValue(-((PrtIntValue)(new PrtIntValue(1))).nt))).Clone();
                    (parent).PrtPushFunStackFrame(BroadCastAcceptors, (BroadCastAcceptors).CreateLocals(Events.event_prepare, new PrtNamedTupleValue(Types.type_16_115039180, parent.self, (parent).var_nextSlotForProposer, new PrtNamedTupleValue(Types.type_2_115039180, (((PrtTupleValue)((parent).var_nextProposal)).fieldValues[0]).Clone(), (parent).var_myRank))));
                    AnonFun9_1:
                        ;
            ...
            static PaxosNode()
            {
                PaxosNode_RunLearner = new PaxosNode_RunLearner_Class("PaxosNode_RunLearner", AnonFun1, AnonFun5, false, StateTemperature.Warm);
                PaxosNode_ProposeValuePhase2 = new PaxosNode_ProposeValuePhase2_Class("PaxosNode_ProposeValuePhase2", AnonFun11, AnonFun23, false, StateTemperature.Warm);
                PaxosNode_ProposeValuePhase1 = new PaxosNode_ProposeValuePhase1_Class("PaxosNode_ProposeValuePhase1", AnonFun9, AnonFun21, false, StateTemperature.Warm);
                PaxosNode_PerformOperation = new PaxosNode_PerformOperation_Class("PaxosNode_PerformOperation", AnonFun14, AnonFun20, false, StateTemperature.Warm);
                PaxosNode_Init = new PaxosNode_Init_Class("PaxosNode_Init", AnonFun12, AnonFun19, false, StateTemperature.Warm);
                ...
                PaxosNode_ProposeValuePhase2.dos.Add(Events.event_accepted, AnonFun4);
                PaxosNode_ProposeValuePhase2.dos.Add(Events.event_agree, PrtFun.IgnoreFun);
                PrtTransition transition_1 = new PrtTransition(AnonFun22, PaxosNode_ProposeValuePhase1, false);
                ...
                PrtTransition transition_3 = new PrtTransition(AnonFun27, PaxosNode_ProposeValuePhase1, false);
                ...
                PrtTransition transition_5 = new PrtTransition(AnonFun2, PaxosNode_ProposeValuePhase1, false);
                PaxosNode_ProposeValuePhase1.transitions.Add(Events.event_reject, transition_5);
                PaxosNode_PerformOperation.dos.Add(Events.event_newLeader, AnonFun8);
                PaxosNode_PerformOperation.dos.Add(Events.event_Ping, AnonFun7);
                PaxosNode_PerformOperation.dos.Add(Events.event_accept, AnonFun6);
                PaxosNode_PerformOperation.dos.Add(Events.event_prepare, AnonFun10);
                PaxosNode_PerformOperation.dos.Add(Events.event_update, AnonFun24);
                ...
                PaxosNode_Init.dos.Add(Events.event_allNodes, AnonFun13);
                PaxosNode_Init.deferredSet.Add(Events.event_Ping);
                PrtTransition transition_8 = new PrtTransition(AnonFun18, PaxosNode_PerformOperation, false);
