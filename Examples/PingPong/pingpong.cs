...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            {
                event_Success = new PrtEventValue(new PrtEvent("Success", Types.type_4_1666091828, PrtEvent.DefaultMaxInstances, false));
                event_Pong = new PrtEventValue(new PrtEvent("Pong", Types.type_4_1666091828, 1, false));
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_1666091828;
            public static PrtType type_2_1666091828;
            public static PrtType type_3_1666091828;
            public static PrtType type_4_1666091828;
            public static PrtType type_PONG;
            static public void Types_pingpong()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_1666091828 = new PrtIntType();
                Types.type_2_1666091828 = new PrtBoolType();
                Types.type_3_1666091828 = new PrtEventType();
                Types.type_4_1666091828 = new PrtNullType();
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\pingpong\\\\pingpong.p(40,7,40,12): error PC1001: Raised event must be non-null");
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun5_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\pingpong\\\\pingpong.p(19,10,19,15): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
            ...
            public class AnonFun8_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    AnonFun8_1:
                        ;
                    if (!!(Events.event_Success).Equals(Events.@null))
                        throw new PrtAssertFailureException("c:\\\\users\\\\peizu\\\\gitroot\\\\p\\\\examples\\\\pingpong\\\\pingpong.p(11,10,11,15): error PC1001: Raised event must be non-null");
                    (application).TraceLine("<RaiseLog> Machine {0}-{1} raised Event {2}", (parent).Name, (parent).instanceNumber, (((PrtEventValue)(Events.event_Success)).evt).name);
                    (parent).currentTrigger = Events.event_Success;
                    (parent).currentPayload = Events.@null;
                    (parent).PrtFunContRaise();
