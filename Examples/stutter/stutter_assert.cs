...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_stutter_assert()
            {
                event_DONE = new PrtEventValue(new PrtEvent("DONE", Types.type_5_1206441174, 1, false));
                event_WAIT = new PrtEventValue(new PrtEvent("WAIT", Types.type_5_1206441174, PrtEvent.DefaultMaxInstances, false));
                event_PING = new PrtEventValue(new PrtEvent("PING", Types.type_5_1206441174, PrtEvent.DefaultMaxInstances, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_1206441174;
            public static PrtType type_2_1206441174;
            public static PrtType type_3_1206441174;
            public static PrtType type_4_1206441174;
            public static PrtType type_5_1206441174;
            public static PrtType type_Client;
            static public void Types_stutter_assert()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_1206441174 = new PrtIntType();
                Types.type_2_1206441174 = new PrtBoolType();
                Types.type_3_1206441174 = new PrtEventType();
                Types.type_4_1206441174 = new PrtNamedTupleType(new object[]{"i", Types.type_1_1206441174});
                Types.type_5_1206441174 = new PrtNullType();
        ...
        public class Client : PrtImplMachine
        {
            ...
            static Client()
            {
                ...
                Client_Consume.dos.Add(Events.event_PING, PrtFun.IgnoreFun);
                Client_Consume.dos.Add(Events.event_WAIT, PrtFun.IgnoreFun);
        ...
        public class Main : PrtImplMachine
        {
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_client)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_PING), Events.@null, parent, (PrtMachineValue)((parent).var_client));
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_client)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_WAIT), Events.@null, parent, (PrtMachineValue)((parent).var_client));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun5_1:
                        ;
                    ...
                    AnonFun5_loop_end_0:
                        ;
                    (((PrtMachineValue)((parent).var_client)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_DONE), Events.@null, parent, (PrtMachineValue)((parent).var_client));
                ...
                public override List<PrtValue> CreateLocals(params PrtValue[] args)
                {
                    ...
                    (locals).Add(PrtValue.PrtMkDefaultValue(Types.type_1_1206441174));
                    return locals;
                }
            ...
            public class AnonFun7_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_client = (application).CreateInterface(parent, "Client", Events.@null);
