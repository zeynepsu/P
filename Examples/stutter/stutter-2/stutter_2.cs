...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_stutter_2()
            {
                event_PING = new PrtEventValue(new PrtEvent("PING", Types.type_5_598168974, PrtEvent.DefaultMaxInstances, false));
                event_DONE = new PrtEventValue(new PrtEvent("DONE", Types.type_5_598168974, 1, false));
                event_WAIT = new PrtEventValue(new PrtEvent("WAIT", Types.type_5_598168974, PrtEvent.DefaultMaxInstances, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_598168974;
            public static PrtType type_2_598168974;
            public static PrtType type_3_598168974;
            public static PrtType type_4_598168974;
            public static PrtType type_5_598168974;
            public static PrtType type_Client;
            static public void Types_stutter_2()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_598168974 = new PrtIntType();
                Types.type_2_598168974 = new PrtBoolType();
                Types.type_3_598168974 = new PrtEventType();
                Types.type_4_598168974 = new PrtNamedTupleType(new object[]{"i", Types.type_1_598168974});
                Types.type_5_598168974 = new PrtNullType();
        ...
        public class Main : PrtImplMachine
        {
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_client0)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_PING), Events.@null, parent, (PrtMachineValue)((parent).var_client0));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun3_1:
                        ;
                    (((PrtMachineValue)((parent).var_client1)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_PING), Events.@null, parent, (PrtMachineValue)((parent).var_client1));
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)((parent).var_client0)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_WAIT), Events.@null, parent, (PrtMachineValue)((parent).var_client0));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun5_1:
                        ;
                    (((PrtMachineValue)((parent).var_client1)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_WAIT), Events.@null, parent, (PrtMachineValue)((parent).var_client1));
                    (parent).PrtFunContSend(this, (currFun).locals, 2);
                    return;
                    AnonFun5_2:
                        ;
                    ...
                    AnonFun5_loop_end_0:
                        ;
                    (((PrtMachineValue)((parent).var_client0)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_DONE), Events.@null, parent, (PrtMachineValue)((parent).var_client0));
                    (parent).PrtFunContSend(this, (currFun).locals, 3);
                    return;
                    AnonFun5_3:
                        ;
                    (((PrtMachineValue)((parent).var_client1)).mach).PrtEnqueueEvent((PrtEventValue)(Events.event_DONE), Events.@null, parent, (PrtMachineValue)((parent).var_client1));
                ...
                public override List<PrtValue> CreateLocals(params PrtValue[] args)
                {
                    ...
                    (locals).Add(PrtValue.PrtMkDefaultValue(Types.type_1_598168974));
                    return locals;
                }
            ...
            public class AnonFun7_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_client0 = (application).CreateInterface(parent, "Client", Events.@null);
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 1);
                    return;
                    AnonFun7_1:
                        ;
                    (parent).var_client1 = (application).CreateInterface(parent, "Client", Events.@null);
