...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        public partial class Events
        {
            ...
            public static void Events_stutter()
            {
                event_DONE = new PrtEventValue(new PrtEvent("DONE", Types.type_5_534450779, PrtEvent.DefaultMaxInstances, false));
                event_WAIT = new PrtEventValue(new PrtEvent("WAIT", Types.type_5_534450779, PrtEvent.DefaultMaxInstances, false));
                event_PING = new PrtEventValue(new PrtEvent("PING", Types.type_5_534450779, PrtEvent.DefaultMaxInstances, false));
            }
        }
        ...
        public partial class Types
        {
            ...
            public static PrtType type_1_534450779;
            public static PrtType type_2_534450779;
            public static PrtType type_3_534450779;
            public static PrtType type_4_534450779;
            public static PrtType type_5_534450779;
            public static PrtType type_Client;
            static public void Types_stutter()
            {
                Types.type_Main = new PrtMachineType();
                Types.type_1_534450779 = new PrtIntType();
                Types.type_2_534450779 = new PrtBoolType();
                Types.type_3_534450779 = new PrtEventType();
                Types.type_4_534450779 = new PrtNamedTupleType(new object[]{"i", Types.type_1_534450779});
                Types.type_5_534450779 = new PrtNullType();
        ...
        public class Main : PrtImplMachine
        {
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override List<PrtValue> CreateLocals(params PrtValue[] args)
                {
                    ...
                    (locals).Add(PrtValue.PrtMkDefaultValue(Types.type_1_534450779));
                    return locals;
                }
